    ...
    
{
    ...
    {
        return _irepdacc.GetTransferHistory(chkAcctNum, jtStartIndex, jtPageSize, jtSorting);
    }
    ...
    {
        return _irepdauth.GetChkAcctNum(UserName);
    }
    ...
    {
        return _irepdacc.GetTransferHistoryCount(chkAcctNum);
    }
}